...
Scene_Title.prototype.createCommandWindow = function() {
    ...
    this._commandWindow.setHandler('notebook',  this.commandNoteBook.bind(this));
    this._commandWindow.setHandler('continue', this.commandContinue.bind(this));
    this._commandWindow.setHandler('options',  this.commandOptions.bind(this));
    this.addWindow(this._commandWindow);
};

Scene_Title.prototype.commandNoteBook = function() {
    // DataManager.setupNewGame();
...
Scene_Battle.prototype.createAllWindows = function() {
    this.createLogWindow();//创建控制台窗口
    this.createStatusWindow();//创建状态窗口
    this.createPartyCommandWindow();//创建参与方命令窗口
    this.createActorCommandWindow();//创建参与者命令窗口
    this.createHelpWindow();//创建帮助窗口
    this.createSkillWindow();//创建技能窗口
    this.createItemWindow();//创建物品窗口
    this.createActorWindow();//创建角色详情窗口
    this.createEnemyWindow();//创建敌人详情窗口
    this.createMessageWindow();//创建对话窗口
    this.createScrollTextWindow();//创建滚动文本窗口
};
